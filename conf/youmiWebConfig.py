...
delFun = None
""" 使用示例：
import mysqlConnectTool
initFun = mysqlConnectTool.mysqlInit()     # web服务启动前，你希望执行的方法，例如数据库连接，没有给None即可
delFun = mysqlConnectTool.mysqlInit()     # 程序启动关闭时，你希望执行的方法，例如数据库关闭，没有给None即可
"""
